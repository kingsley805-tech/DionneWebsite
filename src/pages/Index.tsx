  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="pt-20 md:pt-24 relative overflow-hidden bg-background">
        ...
        <div className="bg-primary text-primary-foreground py-12 relative overflow-hidden -mt-32 md:-mt-40 my-px md:py-0">
          ...
          <img src={iconGavel} alt="" className="absolute -right-2 md:right-0 top-2 md:top-4 w-20 md:w-28 lg:w-32 opacity-80 pointer-events-none" />
          <img src={iconMicrophone} alt="" className="absolute right-0 bottom-0 w-20 md:w-28 lg:w-32 opacity-80 pointer-events-none" />
