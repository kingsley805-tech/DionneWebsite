  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="pt-28 md:pt-36 pb-16 px-4">
        <div className="container mx-auto text-center">
          <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-bold italic mb-10 animate-fade-up" data-aos="fade-down">
            Hi, I'm Dionne
          </h1>

          <div className="max-w-xs md:max-w-sm mx-auto " data-aos="zoom-in" data-aos-delay="200">
          ...
          <div className="max-w-2xl mx-auto space-y-4 py-[2px] my-[20px]">
            <h2 className="font-heading text-2xl md:text-3xl font-semibold text-burgundy my-0 py-[5px]" data-aos="fade-up" data-aos-delay="300">
              Bestselling author,<br />
              transformational speaker,<br />
              and mindset coach,
            </h2>
            <p className="text-muted-foreground text-sm md:text-base leading-relaxed max-w-xl mx-auto py-0 my-0" data-aos="fade-up" data-aos-delay="400">
      ...
      <section className="py-16 md:py-24 px-4 bg-neutral-700">
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            ...
            <div className="space-y-4 text-cream" data-aos="fade-left">
              <p className="text-lg md:text-xl leading-relaxed italic" data-aos="fade-up" data-aos-delay="100">
              ...
              <p className="text-lg md:text-xl leading-relaxed font-semibold" data-aos="fade-up" data-aos-delay="200">
                But I chose to do the inner work, embrace my divine identity, and rise,
                and now, I help women across the globe do the same.
              </p>
              <p className="text-lg md:text-xl leading-relaxed" data-aos="fade-up" data-aos-delay="300">
      ...
      <section className="py-12 md:py-16 px-4 bg-muted">
        <div className="container mx-auto text-center max-w-3xl">
          <p className="text-base md:text-lg leading-relaxed mb-6 italic text-muted-foreground" data-aos="fade-up">
          ...
          <p className="font-heading text-xl md:text-2xl font-semibold text-[#992430]" data-aos="fade-up" data-aos-delay="100">
      ...
      <section className="py-8 px-4 bg-background border-b-2 border-white">
        <div className="container mx-auto">
          <div className="flex justify-center items-center gap-4 md:gap-8 flex-wrap">
            {["Lawyer", "Author", "Entrepreneur", "Coach"].map((role, index) => <div key={role} className="flex items-center gap-4 md:gap-8" data-aos="fade-up" data-aos-delay={index * 100}>
      ...
      <section className="py-12 md:py-16 px-4 bg-muted">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {roles.map((role, index) => <div key={role.title} className="text-cream rounded-2xl p-6 text-center bg-[#7b1e23]" data-aos="zoom-in" data-aos-delay={index * 100}>
